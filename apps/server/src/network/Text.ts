  ...
  private async sendSuperMain() {
    ...
    return this.peer.send(
      Variant.from(
        ...
        `proto=216|choosemusic=audio/mp3/about_theme.mp3|active_holiday=6|wing_week_day=0|ubi_week_day=0|server_tick=${getCurrentTimeInSeconds()}|clash_active=0|drop_lavacheck_faster=1|isPayingUser=1|usingStoreNavigation=1|enableInventoryTab=1|bigBackpack=1|`,
